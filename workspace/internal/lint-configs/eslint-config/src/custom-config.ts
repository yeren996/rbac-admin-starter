...
const customConfig: Linter.Config[] = [
  ...
  {
    files: ['workspace/packages/@core/ui-kit/shadcn-ui/**/**'],
    rules: {
  ...
  },
  {
    ...
    files: ['workspace/packages/@core/base/**/**'],
    ignores: restrictedImportIgnores,
    rules: {
      'no-restricted-imports': [
        'error',
...

  {
    ...
    files: [
      ...
      'workspace/packages/stores/**/**',
      'workspace/packages/preferences/**/**',
      'workspace/packages/locales/**/**',
    ],
    ignores: restrictedImportIgnores,
    rules: {
  ...
  {
    files: ['workspace/internal/**/**', 'workspace/scripts/**/**'],
    rules: {
      'no-console': 'off',
    },
  },
